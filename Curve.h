...
public:
    ...
    Curve(int wid, int hei,  int chennels   )
    {
        //         unsigned  char  * data1 = new  unsigned  char [wid * hei *chennels  ] ;
        data   = new  unsigned  char [wid * hei *chennels  ] ;
    }
